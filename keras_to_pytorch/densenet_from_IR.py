...
def load_weights(weight_file):
    ...
    if ext == ".npy":
        ...
        raise ValueError(f"Unsupported weight file format: {ext}")
...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.conv4_block25_0_bn = self.__batch_normalization(2, 'conv4_block25_0_bn', num_features=1024, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block25_1_conv = self.__conv(2, name='conv4_block25_1_conv', in_channels=1024, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv4_block25_1_bn = self.__batch_normalization(2, 'conv4_block25_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block25_2_conv = self.__conv(2, name='conv4_block25_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv4_block26_0_bn = self.__batch_normalization(2, 'conv4_block26_0_bn', num_features=1056, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block26_1_conv = self.__conv(2, name='conv4_block26_1_conv', in_channels=1056, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv4_block26_1_bn = self.__batch_normalization(2, 'conv4_block26_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block26_2_conv = self.__conv(2, name='conv4_block26_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv4_block27_0_bn = self.__batch_normalization(2, 'conv4_block27_0_bn', num_features=1088, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block27_1_conv = self.__conv(2, name='conv4_block27_1_conv', in_channels=1088, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv4_block27_1_bn = self.__batch_normalization(2, 'conv4_block27_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block27_2_conv = self.__conv(2, name='conv4_block27_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv4_block28_0_bn = self.__batch_normalization(2, 'conv4_block28_0_bn', num_features=1120, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block28_1_conv = self.__conv(2, name='conv4_block28_1_conv', in_channels=1120, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv4_block28_1_bn = self.__batch_normalization(2, 'conv4_block28_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block28_2_conv = self.__conv(2, name='conv4_block28_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv4_block29_0_bn = self.__batch_normalization(2, 'conv4_block29_0_bn', num_features=1152, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block29_1_conv = self.__conv(2, name='conv4_block29_1_conv', in_channels=1152, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv4_block29_1_bn = self.__batch_normalization(2, 'conv4_block29_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block29_2_conv = self.__conv(2, name='conv4_block29_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv4_block30_0_bn = self.__batch_normalization(2, 'conv4_block30_0_bn', num_features=1184, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block30_1_conv = self.__conv(2, name='conv4_block30_1_conv', in_channels=1184, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv4_block30_1_bn = self.__batch_normalization(2, 'conv4_block30_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block30_2_conv = self.__conv(2, name='conv4_block30_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv4_block31_0_bn = self.__batch_normalization(2, 'conv4_block31_0_bn', num_features=1216, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block31_1_conv = self.__conv(2, name='conv4_block31_1_conv', in_channels=1216, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv4_block31_1_bn = self.__batch_normalization(2, 'conv4_block31_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block31_2_conv = self.__conv(2, name='conv4_block31_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv4_block32_0_bn = self.__batch_normalization(2, 'conv4_block32_0_bn', num_features=1248, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block32_1_conv = self.__conv(2, name='conv4_block32_1_conv', in_channels=1248, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv4_block32_1_bn = self.__batch_normalization(2, 'conv4_block32_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv4_block32_2_conv = self.__conv(2, name='conv4_block32_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.pool4_bn = self.__batch_normalization(2, 'pool4_bn', num_features=1280, eps=1.0009999641624745e-05, momentum=0.0)
        self.pool4_conv = self.__conv(2, name='pool4_conv', in_channels=1280, out_channels=640, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block1_0_bn = self.__batch_normalization(2, 'conv5_block1_0_bn', num_features=640, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block1_1_conv = self.__conv(2, name='conv5_block1_1_conv', in_channels=640, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block2_0_bn = self.__batch_normalization(2, 'conv5_block2_0_bn', num_features=672, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block2_1_conv = self.__conv(2, name='conv5_block2_1_conv', in_channels=672, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block3_0_bn = self.__batch_normalization(2, 'conv5_block3_0_bn', num_features=704, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block3_1_conv = self.__conv(2, name='conv5_block3_1_conv', in_channels=704, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block4_0_bn = self.__batch_normalization(2, 'conv5_block4_0_bn', num_features=736, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block4_1_conv = self.__conv(2, name='conv5_block4_1_conv', in_channels=736, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block5_0_bn = self.__batch_normalization(2, 'conv5_block5_0_bn', num_features=768, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block5_1_conv = self.__conv(2, name='conv5_block5_1_conv', in_channels=768, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block6_0_bn = self.__batch_normalization(2, 'conv5_block6_0_bn', num_features=800, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block6_1_conv = self.__conv(2, name='conv5_block6_1_conv', in_channels=800, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block7_0_bn = self.__batch_normalization(2, 'conv5_block7_0_bn', num_features=832, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block7_1_conv = self.__conv(2, name='conv5_block7_1_conv', in_channels=832, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block8_0_bn = self.__batch_normalization(2, 'conv5_block8_0_bn', num_features=864, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block8_1_conv = self.__conv(2, name='conv5_block8_1_conv', in_channels=864, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block9_0_bn = self.__batch_normalization(2, 'conv5_block9_0_bn', num_features=896, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block9_1_conv = self.__conv(2, name='conv5_block9_1_conv', in_channels=896, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block10_0_bn = self.__batch_normalization(2, 'conv5_block10_0_bn', num_features=928, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block10_1_conv = self.__conv(2, name='conv5_block10_1_conv', in_channels=928, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block11_0_bn = self.__batch_normalization(2, 'conv5_block11_0_bn', num_features=960, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block11_1_conv = self.__conv(2, name='conv5_block11_1_conv', in_channels=960, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block12_0_bn = self.__batch_normalization(2, 'conv5_block12_0_bn', num_features=992, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block12_1_conv = self.__conv(2, name='conv5_block12_1_conv', in_channels=992, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block13_0_bn = self.__batch_normalization(2, 'conv5_block13_0_bn', num_features=1024, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block13_1_conv = self.__conv(2, name='conv5_block13_1_conv', in_channels=1024, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block14_0_bn = self.__batch_normalization(2, 'conv5_block14_0_bn', num_features=1056, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block14_1_conv = self.__conv(2, name='conv5_block14_1_conv', in_channels=1056, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block15_0_bn = self.__batch_normalization(2, 'conv5_block15_0_bn', num_features=1088, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block15_1_conv = self.__conv(2, name='conv5_block15_1_conv', in_channels=1088, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block16_0_bn = self.__batch_normalization(2, 'conv5_block16_0_bn', num_features=1120, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block16_1_conv = self.__conv(2, name='conv5_block16_1_conv', in_channels=1120, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        ...
        self.conv5_block17_0_bn = self.__batch_normalization(2, 'conv5_block17_0_bn', num_features=1152, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block17_1_conv = self.__conv(2, name='conv5_block17_1_conv', in_channels=1152, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block17_1_bn = self.__batch_normalization(2, 'conv5_block17_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block17_2_conv = self.__conv(2, name='conv5_block17_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block18_0_bn = self.__batch_normalization(2, 'conv5_block18_0_bn', num_features=1184, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block18_1_conv = self.__conv(2, name='conv5_block18_1_conv', in_channels=1184, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block18_1_bn = self.__batch_normalization(2, 'conv5_block18_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block18_2_conv = self.__conv(2, name='conv5_block18_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block19_0_bn = self.__batch_normalization(2, 'conv5_block19_0_bn', num_features=1216, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block19_1_conv = self.__conv(2, name='conv5_block19_1_conv', in_channels=1216, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block19_1_bn = self.__batch_normalization(2, 'conv5_block19_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block19_2_conv = self.__conv(2, name='conv5_block19_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block20_0_bn = self.__batch_normalization(2, 'conv5_block20_0_bn', num_features=1248, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block20_1_conv = self.__conv(2, name='conv5_block20_1_conv', in_channels=1248, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block20_1_bn = self.__batch_normalization(2, 'conv5_block20_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block20_2_conv = self.__conv(2, name='conv5_block20_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block21_0_bn = self.__batch_normalization(2, 'conv5_block21_0_bn', num_features=1280, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block21_1_conv = self.__conv(2, name='conv5_block21_1_conv', in_channels=1280, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block21_1_bn = self.__batch_normalization(2, 'conv5_block21_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block21_2_conv = self.__conv(2, name='conv5_block21_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block22_0_bn = self.__batch_normalization(2, 'conv5_block22_0_bn', num_features=1312, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block22_1_conv = self.__conv(2, name='conv5_block22_1_conv', in_channels=1312, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block22_1_bn = self.__batch_normalization(2, 'conv5_block22_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block22_2_conv = self.__conv(2, name='conv5_block22_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block23_0_bn = self.__batch_normalization(2, 'conv5_block23_0_bn', num_features=1344, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block23_1_conv = self.__conv(2, name='conv5_block23_1_conv', in_channels=1344, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block23_1_bn = self.__batch_normalization(2, 'conv5_block23_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block23_2_conv = self.__conv(2, name='conv5_block23_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block24_0_bn = self.__batch_normalization(2, 'conv5_block24_0_bn', num_features=1376, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block24_1_conv = self.__conv(2, name='conv5_block24_1_conv', in_channels=1376, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block24_1_bn = self.__batch_normalization(2, 'conv5_block24_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block24_2_conv = self.__conv(2, name='conv5_block24_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block25_0_bn = self.__batch_normalization(2, 'conv5_block25_0_bn', num_features=1408, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block25_1_conv = self.__conv(2, name='conv5_block25_1_conv', in_channels=1408, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block25_1_bn = self.__batch_normalization(2, 'conv5_block25_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block25_2_conv = self.__conv(2, name='conv5_block25_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block26_0_bn = self.__batch_normalization(2, 'conv5_block26_0_bn', num_features=1440, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block26_1_conv = self.__conv(2, name='conv5_block26_1_conv', in_channels=1440, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block26_1_bn = self.__batch_normalization(2, 'conv5_block26_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block26_2_conv = self.__conv(2, name='conv5_block26_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block27_0_bn = self.__batch_normalization(2, 'conv5_block27_0_bn', num_features=1472, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block27_1_conv = self.__conv(2, name='conv5_block27_1_conv', in_channels=1472, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block27_1_bn = self.__batch_normalization(2, 'conv5_block27_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block27_2_conv = self.__conv(2, name='conv5_block27_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block28_0_bn = self.__batch_normalization(2, 'conv5_block28_0_bn', num_features=1504, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block28_1_conv = self.__conv(2, name='conv5_block28_1_conv', in_channels=1504, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block28_1_bn = self.__batch_normalization(2, 'conv5_block28_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block28_2_conv = self.__conv(2, name='conv5_block28_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block29_0_bn = self.__batch_normalization(2, 'conv5_block29_0_bn', num_features=1536, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block29_1_conv = self.__conv(2, name='conv5_block29_1_conv', in_channels=1536, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block29_1_bn = self.__batch_normalization(2, 'conv5_block29_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block29_2_conv = self.__conv(2, name='conv5_block29_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block30_0_bn = self.__batch_normalization(2, 'conv5_block30_0_bn', num_features=1568, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block30_1_conv = self.__conv(2, name='conv5_block30_1_conv', in_channels=1568, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block30_1_bn = self.__batch_normalization(2, 'conv5_block30_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block30_2_conv = self.__conv(2, name='conv5_block30_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block31_0_bn = self.__batch_normalization(2, 'conv5_block31_0_bn', num_features=1600, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block31_1_conv = self.__conv(2, name='conv5_block31_1_conv', in_channels=1600, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block31_1_bn = self.__batch_normalization(2, 'conv5_block31_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block31_2_conv = self.__conv(2, name='conv5_block31_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.conv5_block32_0_bn = self.__batch_normalization(2, 'conv5_block32_0_bn', num_features=1632, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block32_1_conv = self.__conv(2, name='conv5_block32_1_conv', in_channels=1632, out_channels=128, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv5_block32_1_bn = self.__batch_normalization(2, 'conv5_block32_1_bn', num_features=128, eps=1.0009999641624745e-05, momentum=0.0)
        self.conv5_block32_2_conv = self.__conv(2, name='conv5_block32_2_conv', in_channels=128, out_channels=32, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=False)
        self.bn = self.__batch_normalization(2, 'bn', num_features=1664, eps=1.0009999641624745e-05, momentum=0.0)
        self.dense_1 = self.__dense(name = 'dense_1', in_features = 1664, out_features = 6, bias = True)
    ...
    def forward(self, x):
        ...
        conv4_block25_0_bn = self.conv4_block25_0_bn(conv4_block24_concat)
        conv4_block25_0_relu = F.relu(conv4_block25_0_bn)
        conv4_block25_1_conv = self.conv4_block25_1_conv(conv4_block25_0_relu)
        conv4_block25_1_bn = self.conv4_block25_1_bn(conv4_block25_1_conv)
        conv4_block25_1_relu = F.relu(conv4_block25_1_bn)
        conv4_block25_2_conv_pad = F.pad(conv4_block25_1_relu, (1, 1, 1, 1))
        conv4_block25_2_conv = self.conv4_block25_2_conv(conv4_block25_2_conv_pad)
        conv4_block25_concat = torch.cat((conv4_block24_concat, conv4_block25_2_conv,), 1)
        conv4_block26_0_bn = self.conv4_block26_0_bn(conv4_block25_concat)
        conv4_block26_0_relu = F.relu(conv4_block26_0_bn)
        conv4_block26_1_conv = self.conv4_block26_1_conv(conv4_block26_0_relu)
        conv4_block26_1_bn = self.conv4_block26_1_bn(conv4_block26_1_conv)
        conv4_block26_1_relu = F.relu(conv4_block26_1_bn)
        conv4_block26_2_conv_pad = F.pad(conv4_block26_1_relu, (1, 1, 1, 1))
        conv4_block26_2_conv = self.conv4_block26_2_conv(conv4_block26_2_conv_pad)
        conv4_block26_concat = torch.cat((conv4_block25_concat, conv4_block26_2_conv,), 1)
        conv4_block27_0_bn = self.conv4_block27_0_bn(conv4_block26_concat)
        conv4_block27_0_relu = F.relu(conv4_block27_0_bn)
        conv4_block27_1_conv = self.conv4_block27_1_conv(conv4_block27_0_relu)
        conv4_block27_1_bn = self.conv4_block27_1_bn(conv4_block27_1_conv)
        conv4_block27_1_relu = F.relu(conv4_block27_1_bn)
        conv4_block27_2_conv_pad = F.pad(conv4_block27_1_relu, (1, 1, 1, 1))
        conv4_block27_2_conv = self.conv4_block27_2_conv(conv4_block27_2_conv_pad)
        conv4_block27_concat = torch.cat((conv4_block26_concat, conv4_block27_2_conv,), 1)
        conv4_block28_0_bn = self.conv4_block28_0_bn(conv4_block27_concat)
        conv4_block28_0_relu = F.relu(conv4_block28_0_bn)
        conv4_block28_1_conv = self.conv4_block28_1_conv(conv4_block28_0_relu)
        conv4_block28_1_bn = self.conv4_block28_1_bn(conv4_block28_1_conv)
        conv4_block28_1_relu = F.relu(conv4_block28_1_bn)
        conv4_block28_2_conv_pad = F.pad(conv4_block28_1_relu, (1, 1, 1, 1))
        conv4_block28_2_conv = self.conv4_block28_2_conv(conv4_block28_2_conv_pad)
        conv4_block28_concat = torch.cat((conv4_block27_concat, conv4_block28_2_conv,), 1)
        conv4_block29_0_bn = self.conv4_block29_0_bn(conv4_block28_concat)
        conv4_block29_0_relu = F.relu(conv4_block29_0_bn)
        conv4_block29_1_conv = self.conv4_block29_1_conv(conv4_block29_0_relu)
        conv4_block29_1_bn = self.conv4_block29_1_bn(conv4_block29_1_conv)
        conv4_block29_1_relu = F.relu(conv4_block29_1_bn)
        conv4_block29_2_conv_pad = F.pad(conv4_block29_1_relu, (1, 1, 1, 1))
        conv4_block29_2_conv = self.conv4_block29_2_conv(conv4_block29_2_conv_pad)
        conv4_block29_concat = torch.cat((conv4_block28_concat, conv4_block29_2_conv,), 1)
        conv4_block30_0_bn = self.conv4_block30_0_bn(conv4_block29_concat)
        conv4_block30_0_relu = F.relu(conv4_block30_0_bn)
        conv4_block30_1_conv = self.conv4_block30_1_conv(conv4_block30_0_relu)
        conv4_block30_1_bn = self.conv4_block30_1_bn(conv4_block30_1_conv)
        conv4_block30_1_relu = F.relu(conv4_block30_1_bn)
        conv4_block30_2_conv_pad = F.pad(conv4_block30_1_relu, (1, 1, 1, 1))
        conv4_block30_2_conv = self.conv4_block30_2_conv(conv4_block30_2_conv_pad)
        conv4_block30_concat = torch.cat((conv4_block29_concat, conv4_block30_2_conv,), 1)
        conv4_block31_0_bn = self.conv4_block31_0_bn(conv4_block30_concat)
        conv4_block31_0_relu = F.relu(conv4_block31_0_bn)
        conv4_block31_1_conv = self.conv4_block31_1_conv(conv4_block31_0_relu)
        conv4_block31_1_bn = self.conv4_block31_1_bn(conv4_block31_1_conv)
        conv4_block31_1_relu = F.relu(conv4_block31_1_bn)
        conv4_block31_2_conv_pad = F.pad(conv4_block31_1_relu, (1, 1, 1, 1))
        conv4_block31_2_conv = self.conv4_block31_2_conv(conv4_block31_2_conv_pad)
        conv4_block31_concat = torch.cat((conv4_block30_concat, conv4_block31_2_conv,), 1)
        conv4_block32_0_bn = self.conv4_block32_0_bn(conv4_block31_concat)
        conv4_block32_0_relu = F.relu(conv4_block32_0_bn)
        conv4_block32_1_conv = self.conv4_block32_1_conv(conv4_block32_0_relu)
        conv4_block32_1_bn = self.conv4_block32_1_bn(conv4_block32_1_conv)
        conv4_block32_1_relu = F.relu(conv4_block32_1_bn)
        conv4_block32_2_conv_pad = F.pad(conv4_block32_1_relu, (1, 1, 1, 1))
        conv4_block32_2_conv = self.conv4_block32_2_conv(conv4_block32_2_conv_pad)
        conv4_block32_concat = torch.cat((conv4_block31_concat, conv4_block32_2_conv,), 1)
        pool4_bn        = self.pool4_bn(conv4_block32_concat)
        ...
        conv5_block17_0_bn = self.conv5_block17_0_bn(conv5_block16_concat)
        conv5_block17_0_relu = F.relu(conv5_block17_0_bn)
        conv5_block17_1_conv = self.conv5_block17_1_conv(conv5_block17_0_relu)
        conv5_block17_1_bn = self.conv5_block17_1_bn(conv5_block17_1_conv)
        conv5_block17_1_relu = F.relu(conv5_block17_1_bn)
        conv5_block17_2_conv_pad = F.pad(conv5_block17_1_relu, (1, 1, 1, 1))
        conv5_block17_2_conv = self.conv5_block17_2_conv(conv5_block17_2_conv_pad)
        conv5_block17_concat = torch.cat((conv5_block16_concat, conv5_block17_2_conv,), 1)
        conv5_block18_0_bn = self.conv5_block18_0_bn(conv5_block17_concat)
        conv5_block18_0_relu = F.relu(conv5_block18_0_bn)
        conv5_block18_1_conv = self.conv5_block18_1_conv(conv5_block18_0_relu)
        conv5_block18_1_bn = self.conv5_block18_1_bn(conv5_block18_1_conv)
        conv5_block18_1_relu = F.relu(conv5_block18_1_bn)
        conv5_block18_2_conv_pad = F.pad(conv5_block18_1_relu, (1, 1, 1, 1))
        conv5_block18_2_conv = self.conv5_block18_2_conv(conv5_block18_2_conv_pad)
        conv5_block18_concat = torch.cat((conv5_block17_concat, conv5_block18_2_conv,), 1)
        conv5_block19_0_bn = self.conv5_block19_0_bn(conv5_block18_concat)
        conv5_block19_0_relu = F.relu(conv5_block19_0_bn)
        conv5_block19_1_conv = self.conv5_block19_1_conv(conv5_block19_0_relu)
        conv5_block19_1_bn = self.conv5_block19_1_bn(conv5_block19_1_conv)
        conv5_block19_1_relu = F.relu(conv5_block19_1_bn)
        conv5_block19_2_conv_pad = F.pad(conv5_block19_1_relu, (1, 1, 1, 1))
        conv5_block19_2_conv = self.conv5_block19_2_conv(conv5_block19_2_conv_pad)
        conv5_block19_concat = torch.cat((conv5_block18_concat, conv5_block19_2_conv,), 1)
        conv5_block20_0_bn = self.conv5_block20_0_bn(conv5_block19_concat)
        conv5_block20_0_relu = F.relu(conv5_block20_0_bn)
        conv5_block20_1_conv = self.conv5_block20_1_conv(conv5_block20_0_relu)
        conv5_block20_1_bn = self.conv5_block20_1_bn(conv5_block20_1_conv)
        conv5_block20_1_relu = F.relu(conv5_block20_1_bn)
        conv5_block20_2_conv_pad = F.pad(conv5_block20_1_relu, (1, 1, 1, 1))
        conv5_block20_2_conv = self.conv5_block20_2_conv(conv5_block20_2_conv_pad)
        conv5_block20_concat = torch.cat((conv5_block19_concat, conv5_block20_2_conv,), 1)
        conv5_block21_0_bn = self.conv5_block21_0_bn(conv5_block20_concat)
        conv5_block21_0_relu = F.relu(conv5_block21_0_bn)
        conv5_block21_1_conv = self.conv5_block21_1_conv(conv5_block21_0_relu)
        conv5_block21_1_bn = self.conv5_block21_1_bn(conv5_block21_1_conv)
        conv5_block21_1_relu = F.relu(conv5_block21_1_bn)
        conv5_block21_2_conv_pad = F.pad(conv5_block21_1_relu, (1, 1, 1, 1))
        conv5_block21_2_conv = self.conv5_block21_2_conv(conv5_block21_2_conv_pad)
        conv5_block21_concat = torch.cat((conv5_block20_concat, conv5_block21_2_conv,), 1)
        conv5_block22_0_bn = self.conv5_block22_0_bn(conv5_block21_concat)
        conv5_block22_0_relu = F.relu(conv5_block22_0_bn)
        conv5_block22_1_conv = self.conv5_block22_1_conv(conv5_block22_0_relu)
        conv5_block22_1_bn = self.conv5_block22_1_bn(conv5_block22_1_conv)
        conv5_block22_1_relu = F.relu(conv5_block22_1_bn)
        conv5_block22_2_conv_pad = F.pad(conv5_block22_1_relu, (1, 1, 1, 1))
        conv5_block22_2_conv = self.conv5_block22_2_conv(conv5_block22_2_conv_pad)
        conv5_block22_concat = torch.cat((conv5_block21_concat, conv5_block22_2_conv,), 1)
        conv5_block23_0_bn = self.conv5_block23_0_bn(conv5_block22_concat)
        conv5_block23_0_relu = F.relu(conv5_block23_0_bn)
        conv5_block23_1_conv = self.conv5_block23_1_conv(conv5_block23_0_relu)
        conv5_block23_1_bn = self.conv5_block23_1_bn(conv5_block23_1_conv)
        conv5_block23_1_relu = F.relu(conv5_block23_1_bn)
        conv5_block23_2_conv_pad = F.pad(conv5_block23_1_relu, (1, 1, 1, 1))
        conv5_block23_2_conv = self.conv5_block23_2_conv(conv5_block23_2_conv_pad)
        conv5_block23_concat = torch.cat((conv5_block22_concat, conv5_block23_2_conv,), 1)
        conv5_block24_0_bn = self.conv5_block24_0_bn(conv5_block23_concat)
        conv5_block24_0_relu = F.relu(conv5_block24_0_bn)
        conv5_block24_1_conv = self.conv5_block24_1_conv(conv5_block24_0_relu)
        conv5_block24_1_bn = self.conv5_block24_1_bn(conv5_block24_1_conv)
        conv5_block24_1_relu = F.relu(conv5_block24_1_bn)
        conv5_block24_2_conv_pad = F.pad(conv5_block24_1_relu, (1, 1, 1, 1))
        conv5_block24_2_conv = self.conv5_block24_2_conv(conv5_block24_2_conv_pad)
        conv5_block24_concat = torch.cat((conv5_block23_concat, conv5_block24_2_conv,), 1)
        conv5_block25_0_bn = self.conv5_block25_0_bn(conv5_block24_concat)
        conv5_block25_0_relu = F.relu(conv5_block25_0_bn)
        conv5_block25_1_conv = self.conv5_block25_1_conv(conv5_block25_0_relu)
        conv5_block25_1_bn = self.conv5_block25_1_bn(conv5_block25_1_conv)
        conv5_block25_1_relu = F.relu(conv5_block25_1_bn)
        conv5_block25_2_conv_pad = F.pad(conv5_block25_1_relu, (1, 1, 1, 1))
        conv5_block25_2_conv = self.conv5_block25_2_conv(conv5_block25_2_conv_pad)
        conv5_block25_concat = torch.cat((conv5_block24_concat, conv5_block25_2_conv,), 1)
        conv5_block26_0_bn = self.conv5_block26_0_bn(conv5_block25_concat)
        conv5_block26_0_relu = F.relu(conv5_block26_0_bn)
        conv5_block26_1_conv = self.conv5_block26_1_conv(conv5_block26_0_relu)
        conv5_block26_1_bn = self.conv5_block26_1_bn(conv5_block26_1_conv)
        conv5_block26_1_relu = F.relu(conv5_block26_1_bn)
        conv5_block26_2_conv_pad = F.pad(conv5_block26_1_relu, (1, 1, 1, 1))
        conv5_block26_2_conv = self.conv5_block26_2_conv(conv5_block26_2_conv_pad)
        conv5_block26_concat = torch.cat((conv5_block25_concat, conv5_block26_2_conv,), 1)
        conv5_block27_0_bn = self.conv5_block27_0_bn(conv5_block26_concat)
        conv5_block27_0_relu = F.relu(conv5_block27_0_bn)
        conv5_block27_1_conv = self.conv5_block27_1_conv(conv5_block27_0_relu)
        conv5_block27_1_bn = self.conv5_block27_1_bn(conv5_block27_1_conv)
        conv5_block27_1_relu = F.relu(conv5_block27_1_bn)
        conv5_block27_2_conv_pad = F.pad(conv5_block27_1_relu, (1, 1, 1, 1))
        conv5_block27_2_conv = self.conv5_block27_2_conv(conv5_block27_2_conv_pad)
        conv5_block27_concat = torch.cat((conv5_block26_concat, conv5_block27_2_conv,), 1)
        conv5_block28_0_bn = self.conv5_block28_0_bn(conv5_block27_concat)
        conv5_block28_0_relu = F.relu(conv5_block28_0_bn)
        conv5_block28_1_conv = self.conv5_block28_1_conv(conv5_block28_0_relu)
        conv5_block28_1_bn = self.conv5_block28_1_bn(conv5_block28_1_conv)
        conv5_block28_1_relu = F.relu(conv5_block28_1_bn)
        conv5_block28_2_conv_pad = F.pad(conv5_block28_1_relu, (1, 1, 1, 1))
        conv5_block28_2_conv = self.conv5_block28_2_conv(conv5_block28_2_conv_pad)
        conv5_block28_concat = torch.cat((conv5_block27_concat, conv5_block28_2_conv,), 1)
        conv5_block29_0_bn = self.conv5_block29_0_bn(conv5_block28_concat)
        conv5_block29_0_relu = F.relu(conv5_block29_0_bn)
        conv5_block29_1_conv = self.conv5_block29_1_conv(conv5_block29_0_relu)
        conv5_block29_1_bn = self.conv5_block29_1_bn(conv5_block29_1_conv)
        conv5_block29_1_relu = F.relu(conv5_block29_1_bn)
        conv5_block29_2_conv_pad = F.pad(conv5_block29_1_relu, (1, 1, 1, 1))
        conv5_block29_2_conv = self.conv5_block29_2_conv(conv5_block29_2_conv_pad)
        conv5_block29_concat = torch.cat((conv5_block28_concat, conv5_block29_2_conv,), 1)
        conv5_block30_0_bn = self.conv5_block30_0_bn(conv5_block29_concat)
        conv5_block30_0_relu = F.relu(conv5_block30_0_bn)
        conv5_block30_1_conv = self.conv5_block30_1_conv(conv5_block30_0_relu)
        conv5_block30_1_bn = self.conv5_block30_1_bn(conv5_block30_1_conv)
        conv5_block30_1_relu = F.relu(conv5_block30_1_bn)
        conv5_block30_2_conv_pad = F.pad(conv5_block30_1_relu, (1, 1, 1, 1))
        conv5_block30_2_conv = self.conv5_block30_2_conv(conv5_block30_2_conv_pad)
        conv5_block30_concat = torch.cat((conv5_block29_concat, conv5_block30_2_conv,), 1)
        conv5_block31_0_bn = self.conv5_block31_0_bn(conv5_block30_concat)
        conv5_block31_0_relu = F.relu(conv5_block31_0_bn)
        conv5_block31_1_conv = self.conv5_block31_1_conv(conv5_block31_0_relu)
        conv5_block31_1_bn = self.conv5_block31_1_bn(conv5_block31_1_conv)
        conv5_block31_1_relu = F.relu(conv5_block31_1_bn)
        conv5_block31_2_conv_pad = F.pad(conv5_block31_1_relu, (1, 1, 1, 1))
        conv5_block31_2_conv = self.conv5_block31_2_conv(conv5_block31_2_conv_pad)
        conv5_block31_concat = torch.cat((conv5_block30_concat, conv5_block31_2_conv,), 1)
        conv5_block32_0_bn = self.conv5_block32_0_bn(conv5_block31_concat)
        conv5_block32_0_relu = F.relu(conv5_block32_0_bn)
        conv5_block32_1_conv = self.conv5_block32_1_conv(conv5_block32_0_relu)
        conv5_block32_1_bn = self.conv5_block32_1_bn(conv5_block32_1_conv)
        conv5_block32_1_relu = F.relu(conv5_block32_1_bn)
        conv5_block32_2_conv_pad = F.pad(conv5_block32_1_relu, (1, 1, 1, 1))
        conv5_block32_2_conv = self.conv5_block32_2_conv(conv5_block32_2_conv_pad)
        conv5_block32_concat = torch.cat((conv5_block31_concat, conv5_block32_2_conv,), 1)
        bn              = self.bn(conv5_block32_concat)
        relu            = F.relu(bn)
        ...
        # dropout_1       = F.dropout(input = global_average_pooling2d_1_flatten, p = 0.15000000596046448, training = self.training, inplace = True)
        # dense_1         = self.dense_1(dropout_1)
        # dense_1_activation = F.sigmoid(dense_1)
        out             = self.classifier(global_average_pooling2d_1_flatten)
        return out
