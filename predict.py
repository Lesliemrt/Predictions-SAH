...
if __name__ == "__main__":
    ...
    weights = pd.read_csv(f"{configs.DIR}checkpoints/auc_roc_val_scores_{configs.target_output}.csv")
    top_5_models = sorted(weights, key=lambda x: x['auc_roc_val'], reverse=True)[:5]
